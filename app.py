...
# Inconspicuous version display
st.markdown(
    f"<span style='font-size: 0.8rem; color: #888;'>Version {VERSION}</span>",
    unsafe_allow_html=True,
)
st.caption("Upload Blackbaud Roster, Rediker, and Student Records → get a styled Excel with Master + Summary tabs.")
...
with col1:
    f_bb = st.file_uploader("Blackbaud Roster", type=["xlsx", "xls"])
with col2:
